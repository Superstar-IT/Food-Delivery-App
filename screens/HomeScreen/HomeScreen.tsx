          ...
          <FlatList
            ...
            ListEmptyComponent={() => (
              <View style={{ flex: 1, alignItems: "center" }}>
                ...
                >
                  Once {school.delivery_cap} people register to this school,
                  delivery service will open.{" "}
                </Text>
                <Text style={{ fontWeight: "bold", fontSize: 16 }}>
                  {school.count} / {school.delivery_cap} users
                </Text>
                <RestaurantItem
                  id={1}
                  name={"McDonalds"}
                  ...
                  delivery_cap={school.delivery_cap}
                  delivery="disabled"
                  image="https://cloudmatesfood.s3.eu-central-1.amazonaws.com/mcdonalds.jpg"
                  status="in progress"
                />
                <RestaurantItem
                  id={2}
                  ...
                  delivery_cap={school.delivery_cap}
                  delivery="disabled"
                  image="https://s3.ca-central-1.amazonaws.com/flyte.live/9a1053fcd7ab83640d6b9f8ad2eb888321689101_2033621810194944_7371033447604682752_n.jpg"
                  status="in progress"
                />
                <RestaurantItem
                  id={3}
                  ...
                  delivery_cap={school.delivery_cap}
                  delivery="disabled"
                  image="https://s3.ca-central-1.amazonaws.com/flyte.live/68abb8b599dd201ecddd7c6698e6bc3c82acc3366f2ebf288a0c258bbb80e4ab.jpg"
                  status="in progress"
                />
              </View>
            )}
...
function RestaurantItem(props) {
  ...
  function NotAvailableAlert() {
    Alert.alert(
      ...
      `When ${delivery_cap} people sign up to this school, delivery service will open.`
    );
  }
  function NotAvailableAlertContact() {
    Alert.alert(
      "Restaurant is Not Available",
      `If you would like ${name} to be an option. Please Contact your Flyte Representative.`
    );
  }
        ...
        {delivery === "disabled" && (
          ...
          >
            ...
            <Text style={{ fontSize: 16, color: "white", textAlign: "center" }}>
              {" "}
              When {delivery_cap} people sign up to this school, delivery
              service will open.{" "}
            </Text>
          </View>
        )}
        {delivery === "enabled" && status === "in progress" && (
          <View
            style={[
              style.image,
              {
          ...
          >
            ...
            <Text style={{ fontSize: 16, color: "white", textAlign: "center" }}>
              {" "}
              If you would like {name} to be an option. Please Contact your
              Flyte Representative.{" "}
            </Text>
          </View>
        )}
