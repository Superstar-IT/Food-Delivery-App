...
import RegisterPhoneNumber from "../screens/Auth/RegisterScreenPhoneNumber";
import RegisterAddress from "../screens/Auth/RegisterAddress";
...
function LoginNavigator() {
  return (
    <Login.Navigator initialRouteName="Login" headerMode="none">
      ...
      />
      <Login.Screen name="RegisterAddress" component={RegisterAddress} />
      <Login.Screen
            ...
            try {
              if (!!!data.data.user) {
                ...
                batch(() => {
                  dispatch({
                    type: "LOGIN_SUCCESS",
                    payload: { token: userToken, user: data.data.user }
                  });
                  !!data.data.payments &&
                    dispatch({
                      type: "INIT_PAYMENTS",
            ...
            auth.type === "user"
              ...
              : () => (
                  <View style={{ flex: 1, justifyContent: "center" }}>
                    <Proxima>{JSON.stringify(auth)}</Proxima>
                  </View>
                )
          }
        />
      ...
      >
        <View style={styles.page} key="1">
          <Page
            ...
            text="Our Delivery Fees for all our restaurant partners are only 5%"
            width={"60%"}
            fontSize={36}
        ...
        <View style={styles.page} key="2">
          <Page2
            ...
            text="Want a burger at one place, and a nice milkshake from another? No Extra Fees."
            width={"90%"}
            fontSize={30}
            title="Order from multiple Places at the same time"
            colors={""}
          />
        </View>
        <View style={styles.page} key="3">
          <Page3
            ...
            text="Get your deliciously hot and fresh food Right at the start of lunch"
            width={"95%"}
            fontSize={36}
            title="Delivered right               At the start of lunch"
            colors={""}
          />
        </View>
      </ViewPager>
    ...
    <TouchableOpacity onPress={() => refas.current.setPage(index + 1)}>
      <Animated.View
        style={{
          ...
          backgroundColor:
            index === 0
              ? "rgba(104, 215, 141,0.3)"
              : index === 1 && "rgba(183, 15, 48,.3)",
          borderRadius: 7,
          justifyContent: "center",
          alignItems: "center"
        }}
